...
agrid = {"x":"xh","y":"yh","z":"z_l"}
hourly_diags = {
    "rho":agrid,
    "ahh":agrid,
    "kvu":{"x":"xq","y":"yh","z":"z_l"},
    "e":{"x":"xh","y":"yh","z":"rho2_i"},
    "KE":agrid,
    "KE_visc":agrid,
    "KE_horvisc":agrid,
    "PE_to_KE":agrid,
...
if __name__ == "__main__":
    ...
    for output in outputs:
        ...
        gdataout = Path("/g/data/nm03/ab8992/outputs") / expt / f"{output}" #! Switch to v45 since nm03 is nearly full!
